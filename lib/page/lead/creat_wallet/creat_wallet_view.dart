...
class CreatWalletPage extends GetView<CreatWalletLogic> {
  const CreatWalletPage({Key? key}) : super(key: key);
  ...
  Widget build(BuildContext context) {
    return CupertinoPageScaffold(
      ...
      navigationBar: CupertinoNavigationBar(
        middle: Text(AppS().creat_wallet_title),
        backgroundColor: Colors.white,
      ...
      child: ListView(
        ...
        children: [
          ...
          Text(
            AppS().creat_wallet_tips_content,
