...
class RecoverByMnemonicPage extends GetView<RecoverByMnemonicLogic> {
  const RecoverByMnemonicPage({Key? key}) : super(key: key);
    ...
    return CupertinoPageScaffold(
      ...
      child: ListView(
        ...
        children: [
          ...
          TextField(
            controller: controller.mnemonicEdit,
            textInputAction: TextInputAction.next,
            decoration: InputDecoration(
              contentPadding:
                  const EdgeInsets.symmetric(horizontal: 15, vertical: 15),
              labelText: AppS().recover_import_mnemonic,
